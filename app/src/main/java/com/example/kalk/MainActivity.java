...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvReultText;
    private Button btCalculateResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvReultText = findViewById(R.id.result_text_view);
        btCalculateResult = findViewById(R.id.calculate_result_button);
        btCalculateResult.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            toastError = Toast.makeText(this, R.string.divade_zero, duration);
            toastError.show();
            return;
        ...
        if (correctOperation) {
            ...
            tvReultText.setText(num1 + " " + operation + " " + num2 + "=" + result);
        } else {
            int duration = Toast.LENGTH_SHORT;
            if (toastError != null) {
                toastError.cancel();
